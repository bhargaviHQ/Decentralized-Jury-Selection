...
def variationOfNetworkSize(graph_param_list,jurySize,fileName,mu):
    ...
    ax.set_title('Greedy Probability- Disparity in Selection n = {}; j = {}; mu={} '.format(networkSize,jurySize,mu))
    ax.yaxis.grid(True)
...
variationOfNetworkSize(graph_param_list_01,12,"screenshots/disparity_n_100_j_12_mu_01_GP.jpg",0.1)
variationOfNetworkSize(graph_param_list_02,12,"screenshots/disparity_n_500_j_12_mu_01_GP.jpg",0.1)
variationOfNetworkSize(graph_param_list_03,12,"screenshots/disparity_n_1000_j_12_mu_01_GP.jpg",0.1)
variationOfNetworkSize(graph_param_list_04,12,"screenshots/disparity_n_2500_j_12_mu_01_GP.jpg",0.1)
variationOfNetworkSize(graph_param_list_05,12,"screenshots/disparity_n_10000_j_12_mu_01_GP.jpg",0.1)
variationOfNetworkSize(graph_param_list_06,12,"screenshots/disparity_n_30000_j_12_mu_01_GP.jpg",0.1)