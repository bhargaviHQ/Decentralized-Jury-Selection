...
def variationOfNetworkSize(graph_param_list, jurySize, fileName, mu):
    ...
    ax.set_title('Avg distance b/w juror to juror for n = {}; j = {}; mu={}'.format(networkSize,jurySize,mu))
    ax.yaxis.grid(True)
...
for mu in muList:
    ...
    variationOfNetworkSize(graph_param_list_01,12,"screenshots_max_short_path/max_short_path_n_100_j_12_mu_"+str(mu)+".jpg",mu)
    
    print("Running ... mu value : ",mu," network: 2",)
    variationOfNetworkSize(graph_param_list_02,12,"screenshots_max_short_path/max_short_path_n_500_j_12_mu_"+str(mu)+".jpg",mu)
    
    print("Running ... mu value : ",mu," network: 3",)
    variationOfNetworkSize(graph_param_list_03,12,"screenshots_max_short_path/max_short_path_n_1000_j_12_mu_"+str(mu)+".jpg",mu)
    
    print("Running ... mu value : ",mu," network: 4",)
    variationOfNetworkSize(graph_param_list_04,12,"screenshots_max_short_path/max_short_path_n_2500_j_12_mu_"+str(mu)+".jpg",mu)
    
    print("Running ... mu value : ",mu," network: 5",)
    variationOfNetworkSize(graph_param_list_05,12,"screenshots_max_short_path/max_short_path_n_10000_j_12_mu_"+str(mu)+".jpg",mu)
    
    print("Running ... mu value : ",mu," network: 6",)
    variationOfNetworkSize(graph_param_list_06,12,"screenshots_max_short_path/max_short_path_n_30000_j_12_mu_"+str(mu)+".jpg",mu)
...
for jury in juryList:
    ...
    variationOfNetworkSize(graph_param_list_01,jury,"screenshots_max_short_path/max_short_path_n_100_j_"+str(jury)+"_mu_0.1.jpg",0.1)
    
    print("Running ... jury Size : ",jury," network: 2",)
    variationOfNetworkSize(graph_param_list_02,jury,"screenshots_max_short_path/max_short_path_n_500_j_"+str(jury)+"_mu_0.1.jpg",0.1)
    
    print("Running ... jury Size : ",jury," network: 3",)
    variationOfNetworkSize(graph_param_list_03,jury,"screenshots_max_short_path/max_short_path_n_1000_j_"+str(jury)+"_mu_0.1.jpg",0.1)
    
    print("Running ... jury Size : ",jury," network: 4",)
    variationOfNetworkSize(graph_param_list_04,jury,"screenshots_max_short_path/max_short_path_n_2500_j_"+str(jury)+"_mu_0.1.jpg",0.1)
    
    print("Running ... jury Size : ",jury," network: 5",)
    variationOfNetworkSize(graph_param_list_05,jury,"screenshots_max_short_path/max_short_path_n_10000_j_"+str(jury)+"_mu_0.1.jpg",0.1)
    
    print("Running ... jury Size : ",jury," network: 6",)
    variationOfNetworkSize(graph_param_list_06,jury,"screenshots_max_short_path/max_short_path_n_30000_j_"+str(jury)+"_mu_0.1.jpg",0.1)
