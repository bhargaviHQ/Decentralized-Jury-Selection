...
def plotGraph(xplotList,algorithm_1,algorithm_2,algorithm_3,algorithm_4,fileName,xplotName,jurySize):
    ...
    plt.title('Minimum distance of selection for {}; j = {} '.format(xplotName,jurySize))
...
variationOfNetworkParams(graph_param_list_Networks,xplotList,7,"screenshots_max_cov/max_cov_closeness_network.jpg",xplotName)
...
variationOfJurySize(graph_param_list,xplotList,"screenshots_max_cov/max_cov_closeness_jury.jpg",xplotName)
...
variationOfRandomEdge(graph_param_list,xplotList,7,"screenshots_max_cov/max_cov_closeness_randomEdge.jpg",xplotName)
...
variationOfRewireProb(graph_param_list,xplotList,7,"screenshots_max_cov/max_cov_closeness_rewireProb.jpg",xplotName)