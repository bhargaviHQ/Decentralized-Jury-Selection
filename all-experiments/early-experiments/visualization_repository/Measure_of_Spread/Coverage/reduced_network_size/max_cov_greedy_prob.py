...
def variationOfNetworkSize(graph_param_list, jurySize, fileName, mu):
    ...
    ax.set_title('Greedy Probability - Minimum distance of selection n = {}; j = {}; mu={} '.format(networkSize,jurySize,mu))
    ax.yaxis.grid(True)
...
print("Network 1.... ")
variationOfNetworkSize(graph_param_list_01,12,"screenshots_max_cov/max_cov_greedy_n_100_j_12_mu_01_GP.jpg",0.1)

print("Network 2.... ")
variationOfNetworkSize(graph_param_list_02,12,"screenshots_max_cov/max_cov_greedy_n_500_j_12_mu_01_GP.jpg",0.1)

print("Network 3.... ")
variationOfNetworkSize(graph_param_list_03,12,"screenshots_max_cov/max_cov_greedy_n_1000_j_12_mu_01_GP.jpg",0.1)

print("Network 4.... ")
variationOfNetworkSize(graph_param_list_04,12,"screenshots_max_cov/max_cov_greedy_n_2500_j_12_mu_01_GP.jpg",0.1)

print("Network 5.... ")
variationOfNetworkSize(graph_param_list_05,12,"screenshots_max_cov/max_cov_greedy_n_10000_j_12_mu_01_GP.jpg",0.1)

# print("Network 6.... ")
# variationOfNetworkSize(graph_param_list_06,12,"screenshots_max_cov/max_cov_greedy_n_30000_j_12_mu_01_GP.jpg",0.1)