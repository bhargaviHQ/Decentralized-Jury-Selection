...
for mu in muList:
    ...
    variationOfRadiusSize(graph_param_list_01,12,"screenshots_fractional_cov/frac_cov_n_100_j_12_mu_"+str(mu)+".jpg",mu)
    
    print("Running ... mu value : ",mu," network: 2",)
    variationOfRadiusSize(graph_param_list_02,12,"screenshots_fractional_cov/frac_cov_n_500_j_12_mu_"+str(mu)+".jpg",mu)
...
for jury in juryList:
    ...
    variationOfRadiusSize(graph_param_list_01,jury,"screenshots_fractional_cov/frac_cov_n_100_j_"+str(jury)+"_mu_0.1.jpg",0.1)
    
    print("Running ... jury Size : ",jury," network: 2",)
    variationOfRadiusSize(graph_param_list_02,jury,"screenshots_fractional_cov/frac_cov_n_500_j_"+str(jury)+"_mu_0.1.jpg",0.1)
