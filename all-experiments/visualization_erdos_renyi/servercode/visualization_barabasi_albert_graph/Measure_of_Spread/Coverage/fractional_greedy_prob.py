...
def variationRunAlgo(algoIndex, jurySize, graph, radius,probab):
    iterations = 100
...
def variationOfRadiusSize(graph_param_list, jurySize, fileName, mu):
    ...
    for obj in graph_param_list:
            ...
            for graph in graphObjects:
                for radius in radius_list:
                    ...
                    fractNodeCov_01 = variationRunAlgo(3,jurySize,graph,radius,0.25)
                    fractNodeCov_02 = variationRunAlgo(3,jurySize,graph,radius,0.5)
                    fractNodeCov_03 = variationRunAlgo(3,jurySize,graph,radius,0.75)
                    ...
                    itr = itr + 1
    plt.clf()
    plt.plot(radius_list,fractNodeCovList_01, label="Randomness-75%")
    plt.plot(radius_list,fractNodeCovList_02, label="Randomness-50%")
    plt.plot(radius_list,fractNodeCovList_03, label="Randomness-25%")
    ...
    plt.title('Greedy Probability - Fractional Node Coverage for varying radius size n={}; j = {}; mu={} '.format(networkSize,jurySize,mu))
...
print("Network 1.... ")
variationOfRadiusSize(graph_param_list_01,12,"screenshots_fractional_cov/frac_cov_greedy_n_100_j_12_mu_01_GP.jpg",0.1)

print("Network 2.... ")
variationOfRadiusSize(graph_param_list_02,12,"screenshots_fractional_cov/frac_cov_greedy_n_500_j_12_mu_01_GP.jpg",0.1)

print("Network 3.... ")
variationOfRadiusSize(graph_param_list_03,12,"screenshots_fractional_cov/frac_cov_greedy_n_1000_j_12_mu_01_GP.jpg",0.1)

print("Network 4.... ")
variationOfRadiusSize(graph_param_list_04,12,"screenshots_fractional_cov/frac_cov_greedy_n_2500_j_12_mu_01_GP.jpg",0.1)

print("Network 5.... ")
variationOfRadiusSize(graph_param_list_05,12,"screenshots_fractional_cov/frac_cov_greedy_n_10000_j_12_mu_01_GP.jpg",0.1)

print("Network 6.... ")
variationOfRadiusSize(graph_param_list_06,12,"screenshots_fractional_cov/frac_cov_greedy_n_30000_j_12_mu_01_GP.jpg",0.1)
