...
def variationOfNetworkSize(graph_param_list, jurySize, fileName, mu):
    ...
    for obj in graph_param_list:
            ...
            for graph in graphObjects:
                ...
                # jurySize = round(networkSize*0.04)
    ...
    print("Number of Unique covered elements : ::: ", disparity)
    fig, ax = plt.subplots()
    ax.bar(algoList, disparity, align='center', alpha=0.5, ecolor='black', capsize=10)
    ax.set_ylabel('Unique Coverage of juror')
    ax.set_xticks(algoList)
    ax.set_xticklabels(algoList)
    ax.set_title('Unique Coverage of juror for n = {}; j = {}; mu={}'.format(networkSize,jurySize,mu))
    ax.yaxis.grid(True)
...
for mu in muList:
    ...
    variationOfNetworkSize(graph_param_list_01,12,"screenshot_overlapping_cov/overlap_cov_n_100_j_12_mu_"+str(mu)+".jpg",mu)
    
    print("Running ... mu value : ",mu," network: 2",)
    variationOfNetworkSize(graph_param_list_02,12,"screenshot_overlapping_cov/overlap_cov_n_500_j_12_mu_"+str(mu)+".jpg",mu)
    
    print("Running ... mu value : ",mu," network: 3",)
    variationOfNetworkSize(graph_param_list_03,12,"screenshot_overlapping_cov/overlap_cov_n_1000_j_12_mu_"+str(mu)+".jpg",mu)
    
    print("Running ... mu value : ",mu," network: 4",)
    variationOfNetworkSize(graph_param_list_04,12,"screenshot_overlapping_cov/overlap_cov_n_2500_j_12_mu_"+str(mu)+".jpg",mu)
    
    print("Running ... mu value : ",mu," network: 5",)
    variationOfNetworkSize(graph_param_list_05,12,"screenshot_overlapping_cov/overlap_cov_n_10000_j_12_mu_"+str(mu)+".jpg",mu)
    
    print("Running ... mu value : ",mu," network: 6",)
    variationOfNetworkSize(graph_param_list_06,12,"screenshot_overlapping_cov/overlap_cov_n_30000_j_12_mu_"+str(mu)+".jpg",mu)
...
for jury in juryList:
    ...
    variationOfNetworkSize(graph_param_list_01,jury,"screenshot_overlapping_cov/overlap_cov_n_100_j_"+str(jury)+"_mu_0.1.jpg",0.1)
    
    print("Running ... jury Size : ",jury," network: 2",)
    variationOfNetworkSize(graph_param_list_02,jury,"screenshot_overlapping_cov/overlap_cov_n_500_j_"+str(jury)+"_mu_0.1.jpg",0.1)
    
    print("Running ... jury Size : ",jury," network: 3",)
    variationOfNetworkSize(graph_param_list_03,jury,"screenshot_overlapping_cov/overlap_cov_n_1000_j_"+str(jury)+"_mu_0.1.jpg",0.1)
    
    print("Running ... jury Size : ",jury," network: 4",)
    variationOfNetworkSize(graph_param_list_04,jury,"screenshot_overlapping_cov/overlap_cov_n_2500_j_"+str(jury)+"_mu_0.1.jpg",0.1)
    
    print("Running ... jury Size : ",jury," network: 5",)
    variationOfNetworkSize(graph_param_list_05,jury,"screenshot_overlapping_cov/overlap_cov_n_10000_j_"+str(jury)+"_mu_0.1.jpg",0.1)
    
    print("Running ... jury Size : ",jury," network: 6",)
    variationOfNetworkSize(graph_param_list_06,jury,"screenshot_overlapping_cov/overlap_cov_n_30000_j_"+str(jury)+"_mu_0.1.jpg",0.1)
