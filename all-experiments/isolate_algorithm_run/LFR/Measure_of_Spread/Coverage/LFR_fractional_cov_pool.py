...
def variationOfPoolSize(xplot,graph_param_list, jurySize, fileName,xplotName):
    ...
    fractNodeCovList_01 = [0]*(jurySize)
    fractNodeCovList_02 = [0]*(jurySize)
...
variationOfPoolSize(xplot,graph_param_list,6,"screenshots_fractional_cov/LFR_fractional_cov_pool_size.jpg",xplotName)
