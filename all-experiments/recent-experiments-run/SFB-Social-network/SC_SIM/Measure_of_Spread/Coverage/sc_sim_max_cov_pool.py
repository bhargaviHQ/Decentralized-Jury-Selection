...
def plotGraph(algorithm_1,algorithm_3,algorithm_4,fileName,xplotName,xplot):
    ...
    with open('FB_POOL_max_cover_ba_memenhanced.txt', 'a') as file:
        file.write(str("\n"))
        file.write(str(algorithm_1))

    with open('FB_Random_max_cover_ba_memenhanced.txt', 'a') as file:
        file.write(str("\n"))
        file.write(str(algorithm_3))

    with open('FB_W_0_max_cover_ba_memenhanced.txt', 'a') as file:
        file.write(str("\n"))
