...
def variationRunAlgo(algoIndex, jurySize, graph):
    ...
    if algoIndex == 1:
        ...
        for i in range (0,iterations):
            ...
            selectedSet,occupiedNodes = RCL_coverage_large_tb.rclCoverageSelectionWithSubset_large_tb(graph, jurySize,occupiedNodes,0.4)
...
xplot = [0.000003,0.0000075,0.00002] 
print("Loading....")
