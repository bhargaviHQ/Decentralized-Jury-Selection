...
def plotGraph(algorithm_1,algorithm_3,algorithm_4,fileName,xplotName,xplot):
    ...
    with open('FB_POOL_equality_ba_memenhanced.txt', 'a') as file:
        file.write(str("\n"))
        file.write(str(algorithm_1))

    # with open('FB_Random_equality_ba_memenhanced.txt', 'a') as file:
    #     file.write(str("\n"))
    #     file.write(str(algorithm_3))

    # with open('FB_W_0_Random_equality_ba_memenhanced.txt', 'a') as file:
    #     file.write(str("\n"))
...
def variationOfJurySize(xplot, graph, fileName,xplotName):
    ...
    for jurySize in xplot:
                ...
                # algorithm_4[itr],mean3[itr]= variationRunAlgo(4,size,graph)
