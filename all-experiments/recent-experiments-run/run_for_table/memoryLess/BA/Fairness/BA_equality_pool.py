...
def plotGraph(algorithm_1,algorithm_2,fileName,xplotName,jurySize,xplot):
    ...
    with open('equality_ba_memless.txt', 'a') as file:
...
variationOfPoolSize(xplot,graph_param_list,jurySize,"screenshots_equality/pool_equality.jpg","Varying Pool Size")
