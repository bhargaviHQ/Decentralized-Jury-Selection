...
def variationOfPoolSize(xplot,graph_param_list, jurySize, fileName,xplotName):
    ...
    for obj in graph_param_list:
        for size in xplot:
                ...
                obj.getParams()
                #fractNodeCovList_01[itr] = variationRunAlgo(1,size,graph,0.25,2)
                fractNodeCovList_02[itr] = variationRunAlgo(2,size,graph,0.25,2)
                itr = itr + 1
...
xplot = [6,12,25,50]   
xplotName = "Jury size"
variationOfPoolSize(xplot,graph_param_list,jurySize,"screenshots_fractional_cov/fractional_cov_jury_size.jpg",xplotName)