...
class graphObject:
    ...
    def graphGenerator(self):   
        erg = nk.generators.ErdosRenyiGenerator(5000,0.1)
        ergG = erg.generate()
        return ergG
...
def variationOfPoolSize(xplot,graph_param_list, jurySize, fileName):
    ...
    fractNodeCovList_07 = [0]*len(xplot)
    ...
    for q in range(3):
        for obj in graph_param_list:
                    ...
                    fractNodeCovList_07[itr] = variationRunAlgo(7,graph,betweenness_values,2)
                    ...
                    list_7.append(fractNodeCovList_07[itr])
        
                    itr = itr + 1

    with open("BA_frac_cover_algo_complete_ML.txt", 'a') as file:
