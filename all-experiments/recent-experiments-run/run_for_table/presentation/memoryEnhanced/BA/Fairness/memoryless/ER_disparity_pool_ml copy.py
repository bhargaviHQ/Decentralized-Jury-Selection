...
def variationOfSeedSize(xplot,graph_param_list, jurySize, fileName):
    ...
    for q in range(3):
        ...
        for obj in graph_param_list:
                    ...
                    df7[list_names[itr]] = algorithm_7[itr] 
                    ...
                    list_df7.append(df7.max().max())

    with open("ER_disparity_algo_complete_ML.txt", 'a') as file:
                    ...
                    file.write("\n\n ***")
                    file.write(str(statistics.mean(list_df7)))
                    file.write("\n\n ***")
