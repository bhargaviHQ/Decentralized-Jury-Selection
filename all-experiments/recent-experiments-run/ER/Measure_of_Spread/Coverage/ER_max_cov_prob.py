...
def plotGraph(algorithm_1,algorithm_2,fileName,xplotName,jurySize,xplot):
    ...
    plt.title('Minimum distance of selection for {}'.format(xplotName))
...
variationOfPoolSize(graph_param_list,jurySize,"screenshots_max_cov/ER_max_cov_prob.jpg",xplotName,xplot)
