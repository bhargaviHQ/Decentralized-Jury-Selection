...
def plotGraphstd(algorithm_1,algorithm_2,algorithm_3,algorithm_4,fileName,xplotName,jurySize,xplot):
    ...
    plt.title('Pure Greedy(ER): Fractional Coverage for varying {}'.format(xplotName))
    ...
    plt.xlabel(xplotName, fontsize=10)
    plt.ylabel('Fractional Node Coverage', fontsize=10)
    plt.title('Pool-Coverage(ER): Fractional Coverage for varying {}'.format(xplotName))
    ...
    plt.xlabel(xplotName, fontsize=10)
    plt.ylabel('Fractional Node Coverage', fontsize=10)
    plt.title('Pure Random(ER): Fractional Coverage for varying {}'.format(xplotName))
    ...
    plt.xlabel(xplotName, fontsize=10)
    plt.ylabel('Fractional Node Coverage', fontsize=10)
    plt.title('Pool-Betweenness(ER): Fractional Coverage for varying {}'.format(xplotName))
...
variationOfRadiusSize(xplot,graph_param_list,jurySize,"screenshots_fractional_cov/ER_fractional_cov_radius_size",xplotName)
