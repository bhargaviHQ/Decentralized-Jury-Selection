...
def variationOfJurySize():
    ...
    for obj in graph_param:
            ...
            for graph in graphObjects:
                ...
                plt.legend()
                #plt.show()
                plt.savefig("../../../snapshots/Measure_of_Spread/Diversity/max_short_path/variationOfJurySize.jpg")
...
def variationOfNetworkSize():
    ...
    plt.ylabel('Average distance between jurors', fontsize=10)
    plt.title("Comparision of average distance between jurors for varying network size")

    plt.legend()
    #plt.show()
    plt.savefig("../../../snapshots/Measure_of_Spread/Diversity/max_short_path/variationOfNetworkSize.jpg")
...
def variationOfMuValues():
    ...
    plt.ylabel('Average distance between jurors', fontsize=10)
    plt.title("Comparision of average distance between jurors for varying fraction of inter-community edges")

    plt.legend()
    #plt.show()
    plt.savefig("../../../snapshots/Measure_of_Spread/Diversity/max_short_path/variationOfMuValues.jpg")
